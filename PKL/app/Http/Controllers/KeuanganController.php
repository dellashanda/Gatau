...
class KeuanganController extends Controller
{
    ...
    public function showBarang()
    {
        ...
        return view('keuangan.barang', ['barangs' => $barangs]);
    }
    ...
    public function updateBarang(Request $request)
    {
        ...
        if ($barang) {
            ...
            return redirect()->route('keuangan.showDataBarang')->with('success', 'Data Barang berhasil diperbarui');
        } else {
    ...
    public function showPengajuan()
    {
        ...
        return view('keuangan.pengajuan_kredit', ['anggotaKoperasi' => $anggotaKoperasi]);
    }
    ...
    public function showDataPengajuan()
    {
        ...
        $pengajuan_kredits = Pengajuan_kredit::with('anggota')
                            ->where('jenis_pengajuan', 'uang')
                            ->whereNotIn('status_keuangan', ['Disetujui', 'Ditolak']) // Tambahkan kondisi ini
                            ->simplePaginate(10);

        $anggotaKoperasi = Anggota::all();

        return view('keuangan.pengajuan_kredit', [
    ...
    {
        $pengajuan = Pengajuan_kredit::findOrFail($id);
        $pengajuan->status_keuangan = 'Ditolak';
