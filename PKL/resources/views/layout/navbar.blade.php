<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo mr-1" href="index.html">
          <img src="{{asset('skydash/images/logo_GS_1.png')}}" alt="logo" width="50" height="50"/>
          <span class="brand-text" style="vertical-align: middle; font-size: 18px; font-weight: bold; color: #333;">GUNUNG SLAMAT</span>
      </a>
      <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('skydash/images/logo_GS_1.png')}}" alt="logo"/></a>
    </div>
