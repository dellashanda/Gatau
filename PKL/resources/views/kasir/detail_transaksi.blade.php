        ...
        <div class="card-body">
            ...
            <div style="display: flex; justify-content: flex-start; align-items: flex-start;">
                <div class="filter-container" style="display: flex;">
                    <form id="formFilter" action="{{ route('kasir.detailTransaksi') }}" method="GET" style="display: flex;">
                    ...
                    <tbody>
                        @foreach ($detailTransaksis as $index => $detail)
                            <tr>
                                ...
                                <td>{{ optional($detail->transaksi)->tanggal_penjualan }}</td>
                                <td>{{ optional($detail->transaksi)->no_nota }}</td>
