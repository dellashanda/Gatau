              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="forms-sample" method="POST" action="{{ route('ketua_koperasi.entryBarang') }}" id="formInsertBarang">
                      @csrf
                          ...
                          <div class="modal fade" id="modalEditBarang" tabindex="-1" role="dialog" aria-labelledby="modal_label" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form class="forms-sample" method="POST" action="{{ route('ketua_koperasi.updateBarang', ['kode_barang' => $barang->kode_barang]) }}" id="formEditBarang">
                                      @csrf
                                      @method('PUT')
                                      <div class="form-group">
                                        <label for="kode_barang">Kode Barang</label>
...
$(document).ready(function() {
    $('.btn-edit').on('click', function () {
        ...
        var editUrl = '{{ url("ketua_koperasi/update-barang") }}/' + kode_barang + '?page=' + currentPage;
