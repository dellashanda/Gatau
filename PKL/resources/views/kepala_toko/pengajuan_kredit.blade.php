                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-weight-medium">
                                <form action="{{ route('kepala_toko.setujuiPengajuan', ['id' => $pengajuan_kredit->id]) }}" method="POST">
                                    @csrf
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="{{ route('kepala_toko.tolakPengajuan', ['id' => $pengajuan_kredit->id]) }}" class="btn btn-danger btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menolak pengajuan ini?')">Tolak</a>
                                </div>
                            </td>
                        </tr>
                        @empty
