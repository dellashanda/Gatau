                ...
                <table class="table table-striped table-bordered text-center table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('keuangan.setujuiPengajuan', ['id' => $pengajuan_kredit->id]) }}" class="btn btn-primary btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menyetujui pengajuan ini?')">Setujui</a>
                                    <a href="{{ route('keuangan.tolakPengajuan', ['id' => $pengajuan_kredit->id]) }}" class="btn btn-danger btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menolak pengajuan ini?')">Tolak</a>
                                </div>
                            </td>
                        </tr>
                        @empty
