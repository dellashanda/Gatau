              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="forms-sample" method="POST" action="{{ route('keuangan.entryBarang') }}" id="formInsertBarang">
                      @csrf
                          ...
                          <div class="modal fade" id="modalEditBarang" tabindex="-1" role="dialog" aria-labelledby="modal_label" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form class="forms-sample" method="POST" action="{{ route('keuangan.updateBarang', ['kode_barang' => $barang->kode_barang]) }}" id="formEditBarang">
                                      @csrf
                                      @method('PUT')
                                      <div class="form-group">
                                        <label for="kode_barang">Kode Barang</label>
...
$(document).ready(function() {
    $('.btn-edit').on('click', function () {
        ...
        var editUrl = '{{ url("keuangan/update-barang") }}/' + kode_barang + '?page=' + currentPage;
    ...
    $('#search').on('keyup', function() {
        var query = $(this).val();
        $.ajax({
            url: "{{ url('/keuangan/search-barang') }}",
            type: "GET",
            data: {'search': query},
