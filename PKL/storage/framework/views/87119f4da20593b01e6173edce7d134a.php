              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="forms-sample" method="POST" action="<?php echo e(route('kepala_toko.entryBarang')); ?>" id="formInsertBarang">
                      <?php echo csrf_field(); ?>
                          ...
                          <div class="modal fade" id="modalEditBarang" tabindex="-1" role="dialog" aria-labelledby="modal_label" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form class="forms-sample" method="POST" action="<?php echo e(route('kepala_toko.updateBarang', ['kode_barang' => $barang->kode_barang])); ?>" id="formEditBarang">
                                      <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    $('.btn-edit').on('click', function () {
        ...
        var editUrl = '<?php echo e(url("kepala_toko/update-barang")); ?>/' + kode_barang + '?page=' + currentPage;
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Latihan\pkl\resources\views/kepala_toko/barang.blade.php ENDPATH**/ ?>