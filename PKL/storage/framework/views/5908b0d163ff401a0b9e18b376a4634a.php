...
<div class="col-lg-50 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="harga-anggota"><?php echo e(number_format($barang->harga_anggota, 0, ',', ',')); ?></td>
                                            <td class="harga-nonanggota"><?php echo e(number_format($barang->harga_nonanggota, 0, ',', ',')); ?></td>
                                            <td>
                                                <input type="number" name="items[<?php echo e($index); ?>][jumlah]" class="form-control" value="1">
                                            </td>
                                            <td>
                                                <!-- Sembunyikan input untuk menyimpan kode_barang -->
                                                <input type="hidden" name="items[<?php echo e($index); ?>][kode_barang]" value="<?php echo e($barang->kode_barang); ?>">
                                                <!-- Tombol atau aksi untuk menambah barang ke transaksi -->
                                                <a href="#" class="btn btn-primary btn-sm rounded-2 btn-tambah" 
                                                    data-kode_barang="<?php echo e($barang->kode_barang); ?>"
                                                    data-harga-anggota="<?php echo e($barang->harga_anggota); ?>" 
                                                    data-harga-nonanggota="<?php echo e($barang->harga_nonanggota); ?>">Tambah
                                                </a>
                                            </td>
                                        </tr>
            ...
            <form class="forms-sample" method="POST" action="<?php echo e(route('kasir.checkout')); ?>" id="formCheckout">
            <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    $('#search').on('keyup', function() {
        var query = $(this).val();
        $.ajax({
            url: "<?php echo e(url('search-barang-transaksi')); ?>",
            type: "GET",
            data: {'search': query},
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Latihan\pkl\resources\views/kasir/transaksi.blade.php ENDPATH**/ ?>