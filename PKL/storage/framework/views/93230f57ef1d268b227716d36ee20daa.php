                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-weight-medium">
                                <form action="<?php echo e(route('kepala_toko.setujuiPengajuan', ['id' => $pengajuan_kredit->id])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <select name="suku_bunga" class="form-control" required>
                                        <option disabled selected>Pilih suku bunga</option>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="submit" class="btn btn-primary btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menyetujui pengajuan ini?')">Setujui</button>
                                </form>                                    
                                    <a href="<?php echo e(route('kepala_toko.tolakPengajuan', ['id' => $pengajuan_kredit->id])); ?>" class="btn btn-danger btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menolak pengajuan ini?')">Tolak</a>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Latihan\pkl\resources\views/kepala_toko/pengajuan_kredit.blade.php ENDPATH**/ ?>