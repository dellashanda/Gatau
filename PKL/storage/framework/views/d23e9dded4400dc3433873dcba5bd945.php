                ...
                <table class="table table-striped table-bordered text-center table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('ketua_koperasi.setujuiPengajuan', ['id' => $pengajuan_kredit->id])); ?>" class="btn btn-primary btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menyetujui pengajuan ini?')">Setujui</a>
                                    <a href="<?php echo e(route('ketua_koperasi.tolakPengajuan', ['id' => $pengajuan_kredit->id])); ?>" class="btn btn-danger btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menolak pengajuan ini?')">Tolak</a>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Latihan\pkl\resources\views/ketua_koperasi/pengajuan_kredit.blade.php ENDPATH**/ ?>