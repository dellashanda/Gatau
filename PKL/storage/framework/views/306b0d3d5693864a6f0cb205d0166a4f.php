        ...
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $pembelians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembelian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($pembelian->no_nota); ?></td>
                                <td><?php echo e($pembelian->mitra); ?></td>
                                <td><?php echo e(number_format($pembelian->harga, 0, ',', ',')); ?></td>
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-sm rounded-2 btn-edit" data-toggle="modal" data-target="#modalEditPembelian" data-id="<?php echo e($pembelian->id); ?>">Edit</button>
                                        <a href="<?php echo e(route('deletePembelian', ['id' => $pembelian->id])); ?>" class="btn btn-danger btn-sm rounded-2" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-editPembelian" method="POST" action="<?php echo e(route('kasir.updatePembelian', ['id' => $pembelian->id])); ?>" id="formEditPembelian">
                                          <?php echo csrf_field(); ?>
                                          <?php echo method_field('PUT'); ?>
                                          <input type="hidden" name="id" id="id" value="<?php echo e($pembelian->id); ?>">
                                          <div class="form-group">
                                              <label for="tanggal_pembelian">Tanggal Pembelian</label>
                                              <input type="date" class="form-control" id="tanggal_pembelian" name="tanggal_pembelian" value="<?php echo e($pembelian->tanggal_pembelian); ?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="no_nota">No Nota</label>
                                            <input type="text" class="form-control" id="no_nota" name="no_nota" placeholder="No Nota" value="<?php echo e($pembelian->no_nota); ?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="mitra">Mitra</label>
                                            <input type="text" class="form-control" id="mitra" name="mitra" placeholder="Mitra" value="<?php echo e($pembelian->mitra); ?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga" value="<?php echo e($pembelian->harga); ?>">
                                          </div>
            ...
            <div class="modal fade" id="modalPembelian" tabindex="-1" role="dialog" aria-labelledby="modalPembelian_label" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="form-pembelian" method="POST" action="<?php echo e(route('kasir.entryPembelian')); ?>">
                      <?php echo csrf_field(); ?>
                      <div class="form-group">
                          <label for="tanggal_pembelian">Tanggal Pembelian</label>
            ...
            <nav aria-label="Page navigation example" class="mt-3">
                <ul class="pagination justify-content-end">
                    <?php echo e($pembelians->appends(request()->input())->links()); ?>
...
<script>
    $(document).ready(function () {
      ...
      $('.btn-edit').on('click', function () {
          ...
          var editUrl = '<?php echo e(url("kasir/update-pembelian")); ?>/' + id + '?page=' + currentPage;
      ...
      $('#search').on('keyup', function () {
          ...
          $.ajax({
              url: '<?php echo e(route('searchPembelian')); ?>',
              method: 'GET',
              data: {
                  keyword: keyword
              },
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Latihan\pkl\resources\views/kasir/pembelian.blade.php ENDPATH**/ ?>